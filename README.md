...
![Build and deploy status badge](https://github.com/cipscis/throttle/actions/workflows/build-and-deploy.yml/badge.svg)

## Install

Run `npm install github:cipscis/throttle#semver:1.x`

## Usage

See [Throttle documentation](https://cipscis.github.io/throttle/)

## Development

You will need to install [Node.js](https://nodejs.org/en/) before working on this package.

1. Clone the repository using `git clone https://github.com/cipscis/throttle.git`.
